...
class WordSequence(nn.Module):
    def __init__(self, data):
        ...
        if self.word_feature_extractor == "GRU":
            ...
            # self.lstm1 = nn.GRU(lstm_hidden, 128, num_layers=1, batch_first=True, bidirectional=False)
            ...
            # self.lstm1 = nn.LSTM(lstm_hidden, 128, num_layers=1, batch_first=True, bidirectional=False)
    ...
    def forward(self, word_inputs, feature_inputs, word_seq_lengths, char_inputs, char_seq_lengths, char_seq_recover):
        ...
        if self.word_feature_extractor == "CNN":
            ...
            hidden = None
            # lstm_out, hidden1 = self.lstm(packed_words, hidden1)
            lstm_out, hidden = self.lstm(packed_words, hidden)
            # lstm_out, hidden = self.lstm1(lstm_out)
